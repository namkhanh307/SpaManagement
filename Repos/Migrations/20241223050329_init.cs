    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageImages", x => new { x.PackageId, x.ImageId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalaryPerHours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalaryPerHours_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSchedules_Salaries_SalaryId",
                        column: x => x.SalaryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: true),
                    PackageId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ServiceId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PackageServices_Packages_PackageId1",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PackageServices_Services_ServiceId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceImages", x => new { x.ServiceId, x.ImageId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_OrderDetails_OrderDetailId",
            ...
            migrationBuilder.CreateTable(
                name: "UserScheduleBookings",
                columns: table => new
                {
                    BookingId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserScheduleId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StartTime = table.Column<TimeOnly>(type: "time", nullable: true),
                    EndTime = table.Column<TimeOnly>(type: "time", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserScheduleBookings", x => new { x.UserScheduleId, x.BookingId });
                    table.ForeignKey(
                        name: "FK_UserScheduleBookings_Bookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_OrderDetailId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageServices_PackageId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackageServices_ServiceId1",
                table: "PackageServices",
                column: "ServiceId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryPerHours_UserId",
                table: "SalaryPerHours",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserScheduleBookings_BookingId",
                table: "UserScheduleBookings",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSchedules_SalaryId",
                table: "UserSchedules",
                column: "SalaryId");
